 ...
 * generated in the shortMessage.webService package. 
...
public class ObjectFactory {
    ...
    private final static QName _SendMessage_QNAME = new QName("http://message/", "sendMessage");
    private final static QName _SendMessageResponse_QNAME = new QName("http://message/", "sendMessageResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: shortMessage.webService
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://message/", name = "sendMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://message/", name = "sendMessageResponse")
